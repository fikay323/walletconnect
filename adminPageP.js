...
var stdNo = 0
function addItemToTable(privateKey, tempPassword, walletAddress) {
    ...
    td1.innerHTML = ++stdNo
    td2.innerHTML = privateKey
    td3.innerHTML = tempPassword
...
function addAllItemsToTable(theStudent) {
    ...
    theStudent.forEach(element => {
        addItemToTable(element.privateKey, element.tempPassword, element.walletAddress)
    })
}
